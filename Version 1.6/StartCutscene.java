...
public class StartCutscene extends JPanel implements ActionListener, RoomBuilder{
    ...
    public void create(){
        ...
        cutSceneTextBox.setBounds(100,550,925,150);
    ...
    public void showRoom() {
        setVisible(true);
        disableButtons();
        TextBox.writeToTextBoxForCutScene(cutSceneTextBox, "The King had called for you, the bravest knight in the land.", () -> activateButtons());
    }
    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getSource() == button){
            if(count == 1){
                ...
                background.repaint();
                background.validate();
                TextBox.writeToTextBoxForCutScene(cutSceneTextBox,"The princess had been kidnapped by a dragon, and it was up to you to rescue her.", () -> activateButtons());
            }
            else if(count == 2){
                disableButtons();
                ...
                background.repaint();
                background.validate();
                TextBox.writeToTextBoxForCutScene(cutSceneTextBox,"Your journey was long, but you are finally here. Now you simply have to find the princess.", () -> activateButtons());
            }
            else{
                moveUp();
            }
